...
/* harmony default export */ var date_rangevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    leftLabel: function leftLabel() {
      return this.t('el.datepicker.month' + (this.leftDate.getMonth() + 1)) + ' ' + this.leftDate.getFullYear() + ' ' + this.t('el.datepicker.year');
    },
    rightLabel: function rightLabel() {
      return this.t('el.datepicker.month' + (this.rightDate.getMonth() + 1)) + ' ' + this.rightDate.getFullYear() + ' ' + this.t('el.datepicker.year');
    },
